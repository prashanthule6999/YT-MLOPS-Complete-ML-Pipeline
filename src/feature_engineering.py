...
def apply_tfidf(train_data: pd.DataFrame, test_data: pd.DataFrame, max_features: int) -> tuple:
    ...
    try:
        ...
        logger.debug('tf-idf appllied and data transformed')
        return train_df, test_df
    except Exception as e:
        logger.error('Error during ti-idf transformation: %s', e)
        raise
...
def main():
    ...
    try:
        ...
        save_data(train_df, os.path.join(
            './data', 'processed', 'train_tf-idf.csv'))
        save_data(test_df, os.path.join(
            './data', 'processed', 'test_tf-idf.csv'))
